<nav class="navbar navbar-vertical fixed-left text-light navbar-expand-md navbar-dark bg-gradient-primary"
id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                    <i class="fas fa-chart-pie"" style="color: #f4645f;"></i>
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route("payments") }}">
                        <i class="fas fa-coins"></i> {{ __('Payment') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route("patients") }}">
                        <i class="fas fa-users"></i> {{ __('Patients') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route("promoted") }}">
                        <i class="ni ni-atom text-white"></i> {{ __('Promotions') }}
                    </a>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route("waiting") }}">
                        <i class="ni ni-planet text-white"></i> {{ __('WaitingList') }}
                    </a>
                </li>
